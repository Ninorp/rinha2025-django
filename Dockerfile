...
CMD bash -lc "export PATH=/app/.venv/bin:$PATH && mkdir -p /sockets && chmod 777 /sockets && uvicorn rinha2025.asgi:application --uds /sockets/${APP_SOCKET_NAME:-web.sock} --workers 1"
